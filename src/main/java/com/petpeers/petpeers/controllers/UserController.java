...
public class UserController{	
	...
	public  Re
	sponseEntity<String> UserRegistration(@RequestBody RegistrationRequest registrationRequest){
...
//		}
		...
		if(!userValidation.validateUser(loginRequest)) throw new UserNotFoundException("User Do Not exist");
